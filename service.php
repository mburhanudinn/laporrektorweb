    ...
    if (isset($_POST['function'])){
        ...
        if($userkey==$key){
            if($function=="Register"){
                ...
                $sql = "";
                if($id==""){
                    $sql = "SELECT a.*,b.nama FROM laporan a LEFT JOIN user b ON b.user_id = a.user_id ORDER BY a.id_laporan ASC";
                }else{
                    $sql = "SELECT a.*,b.nama FROM laporan a LEFT JOIN user b ON b.user_id = a.user_id WHERE a.id_laporan = '$id' ORDER BY a.id_laporan ASC";
                }
