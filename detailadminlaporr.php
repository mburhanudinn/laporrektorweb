  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="pages/admin/adminlapornew.php" class="logo"><b></b>ADMIN LAPOR</a>
       ...
       <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="pages/admin/adminlapornew.php">
            ...
            <!-- <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="pages/admin/akademikbaru.php" target="_blank"><i class="fa fa-circle-o"></i> Akademik</a></li>
                <li><a href="pages/admin/kemahasiswaanbaru.php" target="_blank"><i class="fa fa-circle-o"></i> Kemahasiswaan</a></li>
                <li><a href="pages/admin/sarprasbaru.php" target="_blank"><i class="fa fa-circle-o"></i> Sarana dan Prasarana</a></li>
                <li><a href="pages/admin/lainyabaru.php" target="_blank"><i class="fa fa-circle-o"></i> Lainya</a></li>
              </ul>
            </li> -->
            <li>
