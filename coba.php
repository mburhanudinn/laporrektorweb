  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="lapor.html" class="logo"><b></b>LAPOR</a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="pages/tentangkami.html">
                <i class="fa fa-calendar"></i> <span>Tentang Kami</span>
               
              </a>
            </li>
            <li>
              <a href="pages/mailbox/kontakkami.html">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Masukan Laporanmu</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
              ...
              <div class="form-group">
                  ...
                  <textarea class="form-control" rows="12" placeholder="Ketik laporanmu disini ..."></textarea>
                </div>
                <div class="form-group">
                 <div class="input-group input-group-lg">
                <div class="input-group-btn">
                  <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown">Pilih Kategori
                ...
                <div class="form-group">
                  <label for="exampleInputFile">Data Dukung Laporan (Bila diperlukan)</label>
