      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <!DOCTYPE html>
           ...
           <li>
              <a href="adminlapornew.php">
                <i class="fa fa-envelope"></i> <span>Laporan Baru</span>
            ...
            <!-- <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="akademikbaru.php" target="_blank"><i class="fa fa-circle-o"></i> Akademik</a></li>
                <li><a href="kemahasiswaanbaru.php" target="_blank"><i class="fa fa-circle-o"></i> Kemahasiswaan</a></li>
                <li><a href="sarprasbaru.php" target="_blank"><i class="fa fa-circle-o"></i> Sarana dan Prasarana</a></li>
                <li><a href="lainyabaru.php" target="_blank"><i class="fa fa-circle-o"></i> Lainya</a></li>
              </ul>
            </li> -->
            <li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <a role="button" class="btn btn-primary btmmargin" href="trashadmin.php"> Admin
                  <span class="glyphicon" aria-hidden="true"></span>
                  </a> 

                  <a role="button" class="btn btn-primary btmmargin" href="trashuser.php"> User
                  <span class="glyphicon" aria-hidden="true"></span>
                  </a> 

                  <a role="button" class="btn btn-primary btmmargin" href="trashlaporan.php"> Laporan
                  <span class="glyphicon" aria-hidden="true"></span>
                  </a>
                ...
                <div class="box-body">
                  ...
                  <th style="text-align: center; width: 225px">Nama Lengkap</th>
                  <th style="text-align: center;">Username</th>
                  <th style="text-align: center; width: 225px">NIM</th>
                  <th style="text-align: center; width: 225px">Jurusan</th>
                  <th style="text-align: center; width: 175px">Fakultas</th>
                  <th style="text-align: center; width: 175px">Angkatan</th>
...
<?php
               $query = "SELECT *  FROM user WHERE keterangan='0'";
          ...
          <tr>
            ...
            <td style="text-align: center;"> <?php echo $data['angkatan'];?></td>
             ...
             <td class="text-center">
                ...
                <a href="softdelete2.php?user_id=<?php echo $data['user_id'] ?>" onclick="javascript: return confirm('Anda yakin hapus data ?')">

               <span class="glyphicon glyphicon-send" aria-hidden="true">Restore</span></a>
                <a href="../hapususer.php?user_id=<?php echo $data['user_id'] ?>" onclick="javascript: return confirm('Anda yakin hapus data ?')">
