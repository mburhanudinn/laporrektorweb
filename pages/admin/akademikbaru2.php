...
if($_SESSION['level']!="akademik"){
  ...
  echo "<script language=\"JavaScript\">\n";
      echo "alert('Anda Bukan Admin Akademik');\n";
      echo "location='adminlapornew3.php'";
      echo "</script>";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Laporan Masuk Kategori Akademik
            <small></small>
          </h1>
          <ol class="breadcrumb">
       ...
       if(isset($_GET['cari'])){
                  ...
                  $query = mysql_query("SELECT * FROM laporan where nama_kategori='Akademik' AND ket_lap='0'");
                }
          $no = 1;
            ...
            <td style="text-align: justify;"> <?php echo $data['status'];?></td>
            <td class="text-center">
                ...
                <a href="../../tolakadminlaporakademik.php?id_laporan=<?php echo $data['id_laporan'] ?>" onclick="javascript: return confirm('Anda yakin tolak laporan ?')">
