...
if($_SESSION['level']!="kemahasiswaan"){
    echo "<script language=\"JavaScript\">\n";
      echo "alert('Anda Bukan Admin Kemahasiswaan!');\n";
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="kemahasiswaanbaru.php" class="logo"><b></b>KEMAHASISWAAN</a>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="kemahasiswaanbaru.php">
                <i class="fa fa-envelope"></i> <span>Laporan Kemahasiswaan</span>
      ...
      <div class="content-wrapper">
       ...
       if(isset($_GET['cari'])){
                  ...
                  $query = mysql_query("SELECT * FROM laporan where nama_kategori='Kemahasiswaan' AND ket_lap='1' AND status_lap='new'");
                }
          $no = 1;
            ...
            <td class="text-center">
                <a href="../../detailadminlaporkemahasiswaan.php?id_laporan=<?php echo $data['id_laporan']; ?>"> 
                ...
                <a href="../../tolakadminlaporkemahasiswaan.php?id_laporan=<?php echo $data['id_laporan'] ?>" onclick="javascript: return confirm('Anda yakin tolak laporan ?')">
