    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
       ...
       if(isset($_GET['cari'])){
                  ...
                  $query = mysql_query("SELECT * FROM laporan where ket_lap='0'");
                }
          $no = 1;
                while ($data = mysql_fetch_array($query)) {
                ?>
            ...
            <td class="text-center">
                ...
                <a href="softdelete3.php?id_laporan=<?php echo $data['id_laporan'] ?>" onclick="javascript: return confirm('Anda yakin tolak laporan ?')">
