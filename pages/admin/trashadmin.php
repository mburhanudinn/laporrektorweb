...
<?php
               $query = "SELECT *  FROM admin WHERE keterangan='0'";
        ...
        ?>
          <tr>
            ...
            <td style="text-align: center;"> <?php echo $data['useradmin'];?></td>
            <td style="text-align: center;"> <?php echo $data['password'];?></td>
             <td style="text-align: center;">


             <a href="softdeleteadmin2.php?id_admin=<?php echo $data['id_admin'] ?>" onclick="javascript: return confirm('Anda yakin Restore data ?')">
            ...
            <!--  <?php echo "<a href='#myModal' class='glyphicon glyphicon-send' id_admin='id_admin' data-toggle='modal' data-id_admin=".$data['id_admin'].">Restore</a>"; ?>
