...
<?php
          ...
          <tr>
            ...
            <td style="text-align: center;"> <?php echo $data['password'];?></td>
             <td style="text-align: center;"><?php echo "<a href='#myModal' class='btn btn-default btn-small' id_admin='id_admin' data-toggle='modal' data-id_admin=".$data['id_admin'].">Update</a>"; ?></td>
