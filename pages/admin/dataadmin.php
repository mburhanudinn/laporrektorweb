    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
             <a role="button" class="btn btn-primary btmmargin" href="#myModal2" data-toggle="modal"> Tambah Admin
...
<?php
               $query = "SELECT *  FROM admin where keterangan='1'";
          ...
          <tr>
            ...
            <td style="text-align: center;"> <?php echo $data['password'];?></td>
             ...
             <?php echo "<a href='#myModal' class='glyphicon glyphicon-pencil' id_admin='id_admin' data-toggle='modal' data-id_admin=".$data['id_admin'].">Update</a>"; ?>

            <a href="softdeleteadmin.php?id_admin=<?php echo $data['id_admin'] ?>" onclick="javascript: return confirm('Anda yakin hapus data ?')">
