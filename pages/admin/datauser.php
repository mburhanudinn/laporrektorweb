...
<?php
               $query = "SELECT *  FROM user where keterangan='1'";
          ...
          <tr>
            ...
            <td style="text-align: center;"> <?php echo $data['angkatan'];?></td>
             ...
             <td class="text-center">
                ...
                <?php echo "<a href='#myModal' class='glyphicon glyphicon-pencil' user_id='user_id' data-toggle='modal' data-user_id=".$data['user_id'].">Update</a>"; ?>  
                <a href="softdelete.php?user_id=<?php echo $data['user_id'] ?>" onclick="javascript: return confirm('Anda yakin hapus data ?')">
