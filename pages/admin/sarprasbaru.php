...
//cek level user
if($_SESSION['level']!="sarpras"){
    echo "<script language=\"JavaScript\">\n";
      echo "alert('Anda Bukan Admin Sarana dan Prasarana!');\n";
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="sarprasbaru.php" class="logo"><b></b>SARPRAS</a>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="sarprasbaru.php">
                <i class="fa fa-envelope"></i> <span>Laporan Sarpras</span>
      ...
      <div class="content-wrapper">
       ...
       if(isset($_GET['cari'])){
                  ...
                  $query = mysql_query("SELECT * FROM laporan where nama_kategori='Sarana dan Prasarana' AND ket_lap='1' AND status_lap='new'");
                }
          $no = 1;
            ...
            <td class="text-center">
                <a href="../../detailadminlaporsarpras.php?id_laporan=<?php echo $data['id_laporan']; ?>"> 
