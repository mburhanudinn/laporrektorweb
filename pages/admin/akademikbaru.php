  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="akademikbaru.php" class="logo"><b></b>AKADEMIK</a>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="akademikbaru.php">
                <i class="fa fa-envelope"></i> <span>Laporan Akademik</span>
      ...
      <div class="content-wrapper">
       ...
       if(isset($_GET['cari'])){
                  ...
                  $query = mysql_query("SELECT * FROM laporan where nama_kategori='Akademik' AND ket_lap='1' AND status_lap='new'");
                }
          $no = 1;
            ...
            <td class="text-center">
                <a href="../../detailadminlaporakademik.php?id_laporan=<?php echo $data['id_laporan']; ?>"> 
