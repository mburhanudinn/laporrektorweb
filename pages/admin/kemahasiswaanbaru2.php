  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Laporan Masuk Kategori Kemahasiswaan
            <small></small>
          </h1>
          <ol class="breadcrumb">
       ...
       if(isset($_GET['cari'])){
                  ...
                  $query = mysql_query("SELECT * FROM laporan where nama_kategori='Kemahasiswaan' AND ket_lap='0'");
                }
          $no = 1;
            ...
            <td class="text-center">
                ...
                <a href="../../tolakadminkemahasiswaan.php?id_laporan=<?php echo $data['id_laporan'] ?>" onclick="javascript: return confirm('Anda yakin tolak laporan ?')">
    ...
    $(document).ready(function(){
        $('#myModal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url : 'detaillaporkemahasiswaan.php',
