    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <!-- <th style="text-align: center; width: 225px">Aksi Lanjutan</th> -->
       ...
       if(isset($_GET['cari'])){
                  ...
                  $query = mysql_query("SELECT * FROM laporan where ket_lap='0' AND aksilanjutan ='sudah'");
                }
          $no = 1;
            ...
            <!-- <td style="text-align: center;"> <?php echo $data['aksilanjutan'];?></td> -->
