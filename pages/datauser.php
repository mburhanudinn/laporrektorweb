...
<html>
  <head>
    <meta charset="UTF-8">
    <title>DATA USER LAPOR REKTOR</title>
        ...
        <div class="col-md-12">
         ...
         <div class="box">
            <div class="box-header">
              <h1 style="font-size: 30px"class="box-title">Data User LAPOR</h1>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <tr>
                  ...
                  <th style="text-align: center; width: 150px">User ID</th>
                  ...
                  <th style="text-align: center; width: 225px">Fakultas</th>
                  <th style="text-align: center; width: 200px">Angkatan</th>
            ...
            <td style="text-align: justify;"> <?php echo $data['username'];?></td>
            ...
            <td class="text-center">
               <!--  <a href='adminlapor.php'> 
                ...
                <a href="ubahdatauser.php?user_id=<?php echo $data['user_id']; ?>"> 
