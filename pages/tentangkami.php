    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <!-- search form -->
         <form action="admin/lihatlapor.php" method="get" class="sidebar-form">
        ...
        <section class="content-header">
          ...
          <div class="box">
            ...
            <div style="text-align: justify" class="box-body" >
              ...
              <p> Laporan akan diverifikasi dan diteruskan kepada Lembaga yang berwenang untuk dapat ditindaklanjuti. Mahasiswa juga dapat mengawal penanganan setiap laporan secara transparan dan akuntabel melalui berbagai fitur yang tersedia.</p>

              <p>Verifikasi Laporan</p>

              <p>Verifikasi laporan adalah proses pemeriksaan substansi laporan oleh admin (pihak Humas Undip) dalam waktu paling lambat 3 (tiga) hari kerja. Verifikasi dilakukan untuk memastikan setiap laporan disampaikan secara jelas, lengkap, dan kronologis serta disertai data dukung yang memadai (jika ada). Verifikasi sangat penting agar laporan mahasiswa dapat diteruskan kepada Lembaga / BIRO yang tepat dan mempermudah proses tindak lanjut laporan. Pada saat verifikasi laporan, admin akan memandu pelapor jika terdapat informasi dan data yang perlu dilengkapi. Mahasiswa tidak perlu ragu terkait kewenangan Lembaga / BIRO yang dituju. Laporan yang jelas, lengkap, dan kronologis akan diteruskan kepada Lembaga / BIRO yang berwenang untuk dapat ditindaklanjuti. </p>

              <p>Tindak Lanjut Laporan</p>
              <p>Lembaga / BIRO diwajibkan menindaklanjuti setiap aspirasi dan pengaduan secara cepat dan tepat sesuai tugas, fungsi, dan kewenangannya. Lembaga / BIRO akan melakukan analisis terhadap substansi laporan, berkoordinasi dengan pihak-pihak terkait, menindaklanjuti di lapangan, serta memberikan jawaban resmi melalui aplikasi LAPOR!. </p>

              <p>Fitur Pendukung</p>
              <p>LAPOR! memiliki fitur-fitur pendukung yang disediakan bagi pengguna, antara lain: 
              <p>1. Tracking ID
              merupakan kode unik yang dapat digunakan untuk memantau status penanganan setiap laporan.</p>

              <p>2. Kolom Laporan
              merupakan kolom dimana user bisa melihat laporan yang sudah masuk. dan juga bisa mengecek laporan tersebut apakah ada yang sudah melaporkan laporan sejenis dengan yang akan user laporkan</p>
              <p>3. Kolom status
              Kolom status adalah Pada saat laporan ditindaklanjuti akan muncul di kolom status dan akan ada keterangan dari lembaga / BIRO terkait laporan mahasiswa sudah ditindaklanjuti sampai mana. </p>

              <center><img width=660 height=660 src='../images/melapor.png' /></center>
