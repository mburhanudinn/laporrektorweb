...
<html>
  <head>
    <meta charset="UTF-8">
    <title>DATA ADMIN LAPOR REKTOR</title>
  ...
  $id_admin = $_GET['id_admin']; //id=hp

  
  //doing read process from database
  $query = mysql_query("select id_admin, username, password from admin where id_admin='$id_admin'");
  ...
  ?>
          ...
          <div class="container">
    <h2 class="title" style="text-align: center">Ubah Data Admin</h2>
    <form class="form-horizontal" action="updatedataadmin.php" method="post" role="form">
  
       <div class="form-group">
        <label class="col-sm-2 control-label">ID Admin</label>
        <div class="col-sm-10">
          <input style="width: 150px" class="form-control" name="id_admin" type="text" value="<?php echo $data['id_admin'];?>" readonly>
        </div>
      </div> 
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10">
          <input style="width: 150px" class="form-control" name="username" type="text" value="<?php echo $data['username'];?>">
        </div>
      </div> 
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10">
          <input style="width: 150px" class="form-control" name="password" type="text" value="<?php echo $data['password'];?>">
        </div>
      </div> 
