        ...
        <div class="col-md-12">
         ...
         <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <tr>
                  ...
                  <th style="text-align: center; width: 150px">ID Laporan</th>
            ...
            <td class="text-center">
                <a class='fa fa-pencil' href='adminlapor.php'> 
                <span  class="glyphicon glyphicon-pencil" aria-hidden="true">Setujui</span></a>  | 
                     
                <a class='fa fa-pencil' href='ubahadminlapor.php?id=<?php echo $row['id_laporan'] ?>'> 
                <span  class="glyphicon glyphicon-pencil" aria-hidden="true">Update</span></a>  | 

                <a class='fa fa-trash-o' href='tolakadminlapor.php?&id=<?php echo $row['id_laporan'] ?>'>
               <span class="glyphicon glyphicon-remove" aria-hidden="true">Tolak</span></a>
                      <!-- <a href="ubahadminlapor.php?id_laporan=<?php echo $data['id_laporan'];?>">Ubah</a>
              <a href="hapusadminlapor.php?id_tagihan=<?php echo $data['id_laporan'];?>" class="red-text" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td> -->
                      <!--  <button type="button" data-toggle="modal" data-target="#edit-data" class="btn btn-success btn-sm" class="glyphicon glyphicon-repeat">Update</button>
