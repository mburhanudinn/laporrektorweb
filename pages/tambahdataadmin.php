  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="admin/adminlapor.php" class="logo"><b></b>ADMIN LAPOR</a>
        ...
        <div class="col-md-12">
         ...
         <div class="box">
            <div class="box-header">
              <center><h2 class="title">Tambah Data Admin</h2></center>
    <form class="form-horizontal" action="admininsert.php" method="post">

      <div class="form-group">
        <label class="col-sm-2 control-label">Id Admin</label>
        <div class="col-sm-6">
            <input class="form-control" name="id_admin" type="text" >
          </div>
      </div>
